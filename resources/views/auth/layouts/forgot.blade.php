...
<head>
    ...
    <link rel="apple-touch-icon" href="{{asset('vandek/app-assets/images/ico/apple-icon-120.png')}}">
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('vandek/app-assets/images/ico/favicon.ico')}}">
...
<!-- BEGIN: Page JS-->
<script src="{{asset('vandek/app-assets/js/scripts/pages/auth-forgot-password.js')}}"></script>
<!-- END: Page JS-->
